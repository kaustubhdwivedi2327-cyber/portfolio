...
const PROJECTS = [
  {
    ...
    steps: [
      ...
      { title: "Modal and LPBF process screens", image: "assets/slat-track/t15_mode_shapes.jpg", imageCaption: "First three dry fixed-base mode shapes of the three designs (Fig. 5.19).", body: "Dry fixed-base modal extraction kept the final design in the reference's low-order band. ANSYS Additive thermal simulation located the sustained hotspot at the root and collar band, and a control run on the incumbent geometry showed the pattern follows build direction, not the redesign." },
  ...
  },
  {
    ...
    highlights: [
      ...
      "Validated the models against manufactured specimens and published data and established where the modelling approach stopped being reliable, rather than reporting agreement uncritically.",
...
const TOOLS = [
  ...
  { name: "nCode DesignLife", level: "Working", note: "EN 1999-1-3 weld-fatigue screening of the incumbent can, cross-checked by an independent shell tangent-stress route.", used: [{ id: "slat-track", label: "Slat-track can" }] },
  { name: "ANSYS Additive", level: "Working", note: "LPBF thermal simulation locating the sustained hotspot at the root and collar band, with a control run on the incumbent geometry.", used: [{ id: "slat-track", label: "Slat-track can" }] },
