...
const PROJECTS = [
  {
    ...
    steps: [
      ...
      { title: "Modal and LPBF process screens", image: "assets/slat-track/t15_mode_shapes.jpg", imageCaption: "First three dry fixed-base mode shapes of the three designs (Fig. 5.19).", body: "Dry fixed-base modal extraction kept the final design in the reference's low-order band. ANSYS Additive thermal simulation located the sustained hotspot at the root and collar band, and a control run on the existing geometry showed the pattern follows build direction, not the redesign." },
...
const TOOLS = [
  ...
  { name: "ANSYS Additive", level: "Working", note: "LPBF thermal simulation locating the sustained hotspot at the root and collar band, with a control run on the existing geometry.", used: [{ id: "slat-track", label: "Slat-track can" }] },
